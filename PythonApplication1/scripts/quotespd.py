#quotespd.py
from matplotlib.finance import quotes_historical_yahoo_ochl     # the latest module name is quotes_historical_yahoo_ochl 
...
def PlotData(code, start, end, list):
    ...
    print start_date
    print end_date
    quotes = quotes_historical_yahoo_ochl(code, start_date, end_date)   # the latest module name is quotes_historical_yahoo_ochl
