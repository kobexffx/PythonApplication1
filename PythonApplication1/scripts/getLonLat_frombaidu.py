...
def mercator2wgs84(mercator):
    ...
    x=point_x=mercator[0]
    y=point_y=mercator[1]
...
def main():
    data=xlrd.open_workbook(r'../input/Book2.xls')
    rtable=data.sheets()[0]
    nrows=rtable.nrows
    values=rtable.col_values(0)
      
    workbook=xlwt.Workbook()
    wtable=workbook.add_sheet('lonlat',cell_overwrite_ok=True)
    row=0
    for value in values:
    ...
    workbook.save(r'../output/data.xls')
#==============================================================================   
